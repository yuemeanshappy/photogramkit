...
def run_relax(input_raw, output_sort, output_color, output_model, metashape, script, darktable):
    print("Starting full relax pipeline...")

    # 1. Sort
    print("Step 1/3: Sorting photos...")
    sort.run_sort(input_raw, output_sort, img_format=img.format, cameras=["bottom", "middle", "top"])
    ...
    color.run_color(output_sort, output_color, darktable, img_format=img.format)
